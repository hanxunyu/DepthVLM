...
Usage:
    python sample_images_matterport3d.py \
        --input_jsonl annotations/matterport3d/mp3d_pixel_depth_test.jsonl \
        --split_file annotations/matterport3d/scenes_test.txt \
        --total_samples 1000 \
        --output_jsonl annotations/matterport3d/test/mp3d_pixel_depth_test_1000.jsonl \
