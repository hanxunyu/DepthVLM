...
Usage:
    python sample_images_nuscenes.py \
        --input_jsonl annotations/nuscenes/nuscenes_pixel_depth_test.jsonl \
        --total_samples 1000 \
        --output_jsonl annotations/nuscenes/test/nuscenes_pixel_depth_test_1000.jsonl \
...
def main():
    ...
    # Initial selection: uniform interval per group
    group_selected_set = {}
