...
Usage:
    python sample_images_waymo.py \
        --input_jsonl annotations/waymo/waymo_pixel_depth_validation.jsonl \
        --total_samples 1000 \
        --output_jsonl annotations/waymo/test/waymo_pixel_depth_validation_1000.jsonl \
